...
CREATE TABLE "HousePayment" (
    ...
    CONSTRAINT "HousePayment_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "HousePayment" ADD CONSTRAINT "HousePayment_houseId_fkey" FOREIGN KEY ("houseId") REFERENCES "House"("id") ON DELETE CASCADE ON UPDATE CASCADE;
